        ...
        <Dialog >
            <DialogTrigger>
                <div className='flex flex-col gap-2 w-[280px] flex-shrink-0 cursor-pointer relative group items-start'>
                    ...
                    <img src={ORG_IMG_URL + film?.horizontalPostURL} className='w-[280px] h-[160px] object-contain rounded-2xl bg-gray-900 top-1/2 left-1/2 group-hover:scale-120 transition-all duration-300 group-hover:shadow-[0_-20px_50px_black] group-hover:z-30 z-0'/>
                ...
                <DialogContent className="bg-gray-900 p-0 pt-4 border-0 max-w-[800px]">
                    ...
                    <div className='relative p-2 md:py-6 px-4 md:px-10 flex flex-col gap-4 md:gap-5'>
                        ...
                        <div className='absolute top-0 bottom-0 left-0 right-0 rounded-b-xl -z-10 bg-gradient-to-t from-primary/50 via-[#09090B]/0 to-[#09090B]/0'></div>
                    </div>
                </DialogContent>            
        </Dialog>

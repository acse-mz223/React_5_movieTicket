...
function Dashboard() {
  return (
    <div>
        <div className='px-6 md:px-16 lg:px-36 py-5 w-full flex justify-center border-b-1'><img className='w-12 h-12 min-w-12 min-h-12' src='/donuts-white.svg'></img></div>

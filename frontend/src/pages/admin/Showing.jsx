                                                ...
                                                return date.showtime.map((showtime, index) =>{
                                                    return (
                                                        <TableRow>
                                                            ...
                                                            <TableCell className="text-center">{showtime.bookedseat.reduce((acc, cur) => acc + cur.seat.length, 0)}</TableCell>
                                                            <TableCell className="text-center">{showtime.bookedseat.reduce((acc, cur) => acc + cur.price, 0)}</TableCell>
                                                        </TableRow>                                                        
                                                    )
                                                })
                                            })
